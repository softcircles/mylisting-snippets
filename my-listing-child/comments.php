                ...
                <div>
                    <div class="element">
                        ...
                        <div class="pf-body">
                            ...
                            <?php ob_start(); ?>
                            <div class="form-group">
                                <input type="hidden" name="redirect_to" value="<?php echo esc_attr( get_the_permalink( get_the_ID() ) ) ?>">
                            </div>
                            <?php $redirect_to = ob_get_clean(); ?>
                            ...
                            <?php
                            $args = array(
                                'comment_field'       => $rating_field . $gallery_field . $message_field . $redirect_to . $submit_field,
                                'class_submit'        => 'hide',
                            ...
                            if ( ! is_user_logged_in() ) {
                                ...
                                $args['comment_field'] = $message_field . $redirect_to .$submit_field;
                            }
                            ?>
