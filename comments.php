				...
				<div>
					<div class="element">
						...
						<div class="pf-body">
							...
							<?php ob_start(); ?>
							    <div class="comment-form-policy md-checkbox">
					                <input id="wp-comment-policy" name="wp-comment-policy" value="yes" class="comment-form-policy__input" type="checkbox" style="width:auto; margin-right:7px;" aria-required="true">
						            <label for="wp-comment-policy"><?php echo sprintf( __( 'I have read and accepted the <a href="%s" target="_blank" class="comment-form-policy__see-more-link">%s</a>', 'my-listing' ), '#', esc_html__( 'Privacy Policy', 'my-listing' ) ); ?></label>
						        </div>
